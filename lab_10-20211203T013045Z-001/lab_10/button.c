...
uint8_t button_getButton() {
    ...
    if((GPIO_PORTE_DATA_R &= 0b00000001) == 0b00000000 ){ //checks for button 1 input
        button_press = 1;
    }

    if((GPIO_PORTE_DATA_R &= 0b00000010) == 0b00000000){ //checks for button 2 input
        button_press = 2;
    }

    if((GPIO_PORTE_DATA_R &= 0b00000100) == 0b00000000){ //checks for button 3 input
        button_press = 3;
    }

    if((GPIO_PORTE_DATA_R &= 0b00001000) == 0b00000000){ //checks for button 4 input
        button_press = 4;
    }
	
	return button_press; // EDIT ME
}
